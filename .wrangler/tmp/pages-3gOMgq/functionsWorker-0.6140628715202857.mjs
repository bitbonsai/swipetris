...
async function exec(env, sql, args = []) {
...
// api/score.js
var int = /* @__PURE__ */ __name((v, min, max) => Number.isInteger(v) && v >= min && v <= max, "int");
function validate(b) {
  ...
  if (!int(b.score, 0, 9999999)) return null;
  if (!int(b.lines, 0, 9999)) return null;
  if (!int(b.level, 1, 99)) return null;
  if (!int(b.pieces, 1, 99999)) return null;
  if (!int(b.durationMs, 0, 864e5)) return null;
...
var submits = /* @__PURE__ */ new Map();
function rateLimited(ip) {
  const now = Date.now();
  const slot = submits.get(ip);
  if (!slot || now > slot.resetAt) {
    submits.set(ip, { count: 1, resetAt: now + 6e4 });
    return false;
  }
  slot.count++;
  if (submits.size > 1e4) submits.clear();
...
// ../.wrangler/tmp/pages-3gOMgq/functionsRoutes-0.6110105988208221.mjs
var routes = [
  {
...
// ../../../../../private/var/folders/q0/6wqyszzn3f55924p0sb72h080000gn/T/bunx-501-wrangler@latest/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// ../../../../../private/var/folders/q0/6wqyszzn3f55924p0sb72h080000gn/T/bunx-501-wrangler@latest/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../../../../../private/var/folders/q0/6wqyszzn3f55924p0sb72h080000gn/T/bunx-501-wrangler@latest/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../../../../../private/var/folders/q0/6wqyszzn3f55924p0sb72h080000gn/T/bunx-501-wrangler@latest/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// ../.wrangler/tmp/bundle-8xcQ7F/middleware-insertion-facade.js
...
// ../../../../../private/var/folders/q0/6wqyszzn3f55924p0sb72h080000gn/T/bunx-501-wrangler@latest/node_modules/wrangler/templates/middleware/common.ts
...
// ../.wrangler/tmp/bundle-8xcQ7F/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.6140628715202857.mjs.map
